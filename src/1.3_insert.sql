...
(1, 1, 'Corredor A', 500.00),
(2, 1, 'Corredor B', 600.00),
(3, 1, 'Zona Frigoríficos', 300.00),
(4, 1, 'Zona de Pequenos Artigos', 400.00),
(5, 2, 'Corredor A', 450.00),
(6, 2, 'Corredor B', 550.00),
(7, 2, 'Zona de Ferragens', 350.00),
(8, 3, 'Corredor A', 480.00),
(9, 3, 'Corredor B', 520.00),
(10, 3, 'Zona de Tintas', 280.00),
(11, 4, 'Corredor A', 400.00),
(12, 4, 'Zona Especial', 300.00),
(13, 5, 'Corredor A', 600.00),
(14, 5, 'Corredor B', 700.00),
(15, 5, 'Zona de Construção', 500.00),
(16, 6, 'Corredor A', 420.00),
(17, 6, 'Corredor B', 430.00),
(18, 7, 'Corredor A', 380.00),
(19, 7, 'Zona de Equipamentos', 320.00),
(20, 8, 'Corredor A', 440.00),
(21, 8, 'Corredor B', 460.00),
(22, 8, 'Zona de Acabamentos', 340.00),
(23, 1, 'Zona de Reserva', 250.00),
(24, 2, 'Zona de Reserva', 200.00),
(25, 3, 'Zona de Reserva', 220.00),
(26, 4, 'Zona de Reserva', 180.00),
(27, 5, 'Zona de Reserva', 300.00),
(28, 6, 'Zona de Reserva', 150.00),
(29, 7, 'Zona de Reserva', 140.00),
(30, 8, 'Zona de Reserva', 160.00);

INSERT INTO Carrier (carrier_id, name, nif, phone, cost_per_hour) VALUES
(1, 'Transportes Silva', '123456789', '22 1234567', 35.50),
(2, 'Logística Express', '987654321', '21 9876543', 45.00),
(3, 'Entregas Rápidas', '456789123', '23 4567890', 38.75),
(4, 'TransPor', '789123456', '22 7891234', 40.00),
(5, 'Rotas do Sul', '321654987', '28 3216549', 32.50),
(6, 'Distribuidora Centro', '654987321', '24 6549873', 36.25),
(7, 'Logística Nacional', '111222333', '21 1112223', 42.00),
(8, 'Entregas 24h', '444555666', '22 4445556', 48.50),
(9, 'TransRápido', '777888999', '23 7778889', 41.75),
(10, 'Logística Verde', '202030304', '25 2020303', 38.00),
(11, 'Distribuição Norte', '505060607', '22 5050606', 39.50),
(12, 'Entregas Eficientes', '808090910', '21 8080909', 44.25),
(13, 'TransCargo', '010101011', '20 1010101', 46.00),
(14, 'Logística Plus', '121212121', '22 1212121', 43.50),
(15, 'Distribuição Direta', '313131313', '24 3131313', 37.75),
(16, 'Entregas Seguras', '414141414', '23 4141414', 40.50),
(17, 'TransLogística', '515151515', '21 5151515', 44.00),
(18, 'Distribuição Rápida', '616161616', '22 6161616', 42.75),
(19, 'Logística Confiável', '717171717', '28 7171717', 35.00),
(20, 'Entregas Pontuais', '818181818', '25 8181818', 39.25),
(21, 'TransEstafeta', '919191919', '23 9191919', 45.50),
(22, 'Distribuição Flexível', '202020202', '21 2020202', 38.50),
(23, 'Logística Integrada', '303030303', '22 3030303', 43.00),
(24, 'Entregas Noturnas', '404040404', '24 4040404', 50.00),
(25, 'TransEspecial', '505050505', '28 5050505', 52.50),
(26, 'Distribuição Premium', '606060606', '21 6060606', 55.00),
(27, 'Logística Europeia', '707070707', '22 7070707', 48.00),
(28, 'Entregas Comerciais', '808080808', '23 8080808', 41.50),
(29, 'TransLocal', '909090909', '25 9090909', 36.50),
(30, 'Distribuição Regional', '010101012', '20 1010102', 37.25);
...
(35, '00000035', 'Natacha Gomes', 'Avenida I, 35', '353535353', 1640.00, 'Motorista', '1980-07-22', 3, 3, 2);
...
(1, 1, 0.12, '2015-01-01', '2017-12-31'),
(2, 1, 0.14, '2018-01-01', '2019-12-31'),
(3, 1, 0.15, '2020-01-01', NULL),
(4, 2, 0.07, '2015-01-01', '2017-12-31'),
(5, 2, 0.08, '2018-01-01', NULL),
(6, 3, 40.00, '2015-01-01', '2017-06-30'),
(7, 3, 42.00, '2017-07-01', '2019-12-31'),
(8, 3, 45.00, '2020-01-01', NULL),
(9, 5, 10.00, '2015-01-01', '2018-12-31'),
(10, 5, 11.00, '2019-01-01', '2019-12-31'),
(11, 5, 12.00, '2020-01-01', NULL),
(12, 10, 7.50, '2015-01-01', '2018-12-31'),
(13, 10, 8.00, '2019-01-01', '2019-12-31'),
(14, 10, 8.50, '2020-01-01', NULL),
(15, 11, 30.00, '2015-01-01', '2017-12-31'),
(16, 11, 32.00, '2018-01-01', '2019-12-31'),
(17, 11, 35.00, '2020-01-01', NULL),
(18, 15, 40.00, '2015-01-01', '2018-12-31'),
(19, 15, 42.00, '2019-01-01', '2019-12-31'),
(20, 15, 45.00, '2020-01-01', NULL),
(21, 20, 150.00, '2015-01-01', '2018-12-31'),
(22, 20, 160.00, '2019-01-01', '2019-12-31'),
(23, 20, 180.00, '2020-01-01', NULL),
(24, 30, 100.00, '2015-01-01', '2018-12-31'),
(25, 30, 110.00, '2019-01-01', '2019-12-31'),
(26, 30, 120.00, '2020-01-01', NULL);

INSERT INTO WarehouseStockDefinition (warehouse_id, product_ref, min_stock) VALUES
(1, 1, 100), (1, 2, 150), (1, 3, 5), (1, 4, 3), (1, 5, 10),
(1, 6, 8), (1, 7, 2), (1, 8, 5), (1, 9, 4), (1, 10, 6),
(2, 1, 80), (2, 2, 120), (2, 3, 4), (2, 4, 3), (2, 5, 8),
(2, 6, 6), (2, 7, 2), (2, 8, 4), (2, 9, 3), (2, 10, 5),
(3, 11, 3), (3, 12, 2), (3, 13, 5), (3, 14, 2), (3, 15, 1),
(3, 16, 5), (3, 17, 10), (3, 18, 20), (3, 19, 1), (3, 20, 1),
(4, 21, 2), (4, 22, 30), (4, 23, 25), (4, 24, 20), (4, 25, 5),
(4, 26, 15), (4, 27, 1), (4, 28, 5), (4, 29, 3), (4, 30, 1),
(5, 1, 120), (5, 2, 180), (5, 3, 6), (5, 4, 4), (5, 5, 12),
(5, 6, 10), (5, 7, 3), (5, 8, 6), (5, 9, 5), (5, 10, 8),
(6, 11, 4), (6, 12, 3), (6, 13, 6), (6, 14, 3), (6, 15, 2),
(6, 16, 6), (6, 17, 12), (6, 18, 25), (6, 19, 2), (6, 20, 2),
(7, 21, 3), (7, 22, 35), (7, 23, 28), (7, 24, 22), (7, 25, 6),
(7, 26, 18), (7, 27, 2), (7, 28, 6), (7, 29, 4), (7, 30, 1),
(8, 1, 90), (8, 2, 140), (8, 3, 4), (8, 4, 3), (8, 5, 9),
(8, 6, 7), (8, 7, 2), (8, 8, 5), (8, 9, 4), (8, 10, 6);

INSERT INTO Stock (physical_zone_id, product_ref, quantity) VALUES
(1, 1, 150), (1, 2, 200), (1, 3, 8), (1, 4, 5), (1, 5, 15),
(1, 6, 12), (1, 7, 3), (1, 8, 8), (1, 9, 6), (1, 10, 10),
(2, 11, 5), (2, 12, 4), (2, 13, 8), (2, 14, 3), (2, 15, 2),
(2, 16, 8), (2, 17, 15), (2, 18, 30), (2, 19, 2), (2, 20, 2),
(3, 21, 3), (3, 22, 40), (3, 23, 30), (3, 24, 25), (3, 25, 7),
(3, 26, 20), (3, 27, 1), (3, 28, 6), (3, 29, 4), (3, 30, 1),
(5, 1, 120), (5, 2, 180), (5, 3, 6), (5, 4, 4), (5, 5, 12),
(5, 6, 10), (5, 7, 3), (5, 8, 6), (5, 9, 5), (5, 10, 8),
(8, 11, 4), (8, 12, 3), (8, 13, 6), (8, 14, 3), (8, 15, 2),
(8, 16, 6), (8, 17, 12), (8, 18, 25), (8, 19, 2), (8, 20, 2),
(11, 1, 100), (11, 2, 160), (11, 3, 5), (11, 4, 3), (11, 5, 10),
(11, 6, 8), (11, 7, 2), (11, 8, 5), (11, 9, 4), (11, 10, 6),
(13, 21, 3), (13, 22, 35), (13, 23, 28), (13, 24, 22), (13, 25, 6),
(13, 26, 18), (13, 27, 2), (13, 28, 6), (13, 29, 4), (13, 30, 1),
(16, 1, 110), (16, 2, 170), (16, 3, 6), (16, 4, 4), (16, 5, 11),
(16, 6, 9), (16, 7, 3), (16, 8, 6), (16, 9, 5), (16, 10, 7),
(18, 11, 3), (18, 12, 2), (18, 13, 5), (18, 14, 2), (18, 15, 1),
(18, 16, 5), (18, 17, 10), (18, 18, 20), (18, 19, 1), (18, 20, 1),
(20, 1, 130), (20, 2, 190), (20, 3, 7), (20, 4, 5), (20, 5, 13),
(20, 6, 11), (20, 7, 3), (20, 8, 7), (20, 9, 6), (20, 10, 9);

INSERT INTO SalesOrder (order_id, registration_date, customer_id, salesperson_id, status) VALUES
(1, '2015-02-10', 1, 9, 'Processada'),
(2, '2015-03-15', 2, 10, 'Processada'),
(3, '2015-04-20', 3, 9, 'Processada'),
(4, '2015-05-25', 4, 11, 'Cancelada'),
(5, '2015-06-30', 5, 12, 'Processada'),
(6, '2015-07-10', 6, 10, 'Pendente'),
(7, '2015-08-15', 7, 9, 'Processada'),
(8, '2015-09-20', 8, 11, 'Processada'),
(9, '2018-03-10', 1, 9, 'Processada'),
(10, '2018-03-15', 2, 10, 'Processada'),
(11, '2018-04-20', 9, 13, 'Processada'),
(12, '2018-05-05', 11, 15, 'Pendente'),
(13, '2018-06-01', 16, 16, 'Processada'),
(14, '2018-06-15', 17, 17, 'Processada'),
(15, '2018-07-01', 23, 19, 'Processada'),
(16, '2018-08-10', 26, 20, 'Processada'),
(17, '2018-08-15', 1, 9, 'Processada'),
(18, '2018-09-20', 2, 10, 'Cancelada'),
(19, '2018-10-25', 3, 9, 'Processada'),
(20, '2019-01-05', 5, 12, 'Processada'),
(21, '2019-02-10', 6, 10, 'Processada'),
(22, '2019-03-15', 7, 9, 'Processada'),
(23, '2019-04-20', 11, 15, 'Processada'),
(24, '2019-05-25', 17, 17, 'Processada'),
(25, '2019-06-30', 26, 20, 'Processada'),
(26, '2019-07-10', 1, 9, 'Processada'),
(27, '2019-08-15', 2, 10, 'Pendente'),
(28, '2019-09-20', 4, 11, 'Processada'),
(29, '2019-10-25', 5, 12, 'Processada'),
(30, '2019-11-30', 6, 10, 'Processada');
...
(1, '2015-02-11', '09:30:00', 21, 1),
(2, '2015-03-16', '10:15:00', 21, 2),
(3, '2015-04-21', '08:45:00', 21, 3),
(4, '2015-06-01', '11:20:00', 23, 5),
(5, '2015-08-16', '09:00:00', 23, 7),
(6, '2015-09-21', '15:30:00', 23, 8),
(7, '2018-03-11', '08:30:00', 21, 9),
(8, '2018-03-16', '09:45:00', 21, 10),
(9, '2018-04-21', '10:15:00', 25, 11),
(10, '2018-06-02', '08:00:00', 25, 13),
(11, '2018-06-16', '09:30:00', 25, 14),
(12, '2018-07-02', '10:00:00', 29, 15),
(13, '2018-08-11', '11:00:00', 29, 16),
(14, '2018-08-16', '14:30:00', 29, 17),
(15, '2018-10-26', '09:15:00', 21, 19),
(16, '2019-01-06', '08:30:00', 21, 20),
(17, '2019-02-11', '10:00:00', 23, 21),
(18, '2019-03-16', '09:30:00', 23, 22),
(19, '2019-04-21', '11:15:00', 25, 23),
(20, '2019-05-26', '10:45:00', 25, 24),
(21, '2019-07-01', '08:45:00', 29, 25),
(22, '2019-07-11', '09:00:00', 29, 26),
(23, '2019-08-16', '10:30:00', 21, 27),
(24, '2019-09-21', '08:30:00', 21, 28),
(25, '2019-10-26', '11:00:00', 23, 29),
(26, '2019-12-01', '10:15:00', 23, 30),
(27, '2018-06-10', '07:30:00', 25, 12),
(28, '2018-07-15', '09:00:00', 29, 13),
(29, '2015-07-15', '14:00:00', 21, 6),
(30, '2019-03-20', '08:15:00', 25, 22);

INSERT INTO DispatchNoteLine (dispatch_id, product_ref, physical_zone_id, quantity) VALUES
(1, 1, 1, 50), (1, 2, 1, 100), (1, 3, 2, 2),
(2, 4, 2, 1), (2, 5, 5, 3), (2, 6, 5, 2), (2, 30, 2, 1),
(3, 11, 2, 2), (3, 12, 2, 1), (3, 13, 2, 3),
(4, 1, 1, 200), (4, 2, 1, 300),
(5, 3, 2, 2), (5, 4, 2, 1), (5, 5, 5, 5),
(6, 7, 2, 1), (6, 8, 2, 5),
(7, 20, 3, 1), (7, 21, 3, 1),
(8, 15, 3, 2), (8, 16, 3, 3),
(9, 1, 1, 100), (9, 2, 1, 150),
(10, 3, 2, 2), (10, 4, 2, 1),
(11, 11, 2, 2), (11, 12, 2, 1), (11, 30, 2, 1),
(12, 5, 5, 4), (12, 6, 5, 2),
(13, 7, 2, 2), (13, 8, 2, 6),
(14, 20, 3, 1), (14, 21, 3, 2),
(15, 1, 1, 50), (15, 2, 1, 75),
...
(1, 1, 1, '2015-02-11 10:00:00', 2.5),
(2, 2, 2, '2015-03-16 11:00:00', 3.0),
(3, 3, 3, '2015-04-21 09:00:00', 2.0),
(4, 4, 4, '2015-06-01 12:00:00', 1.5),
(5, 5, 5, '2015-08-16 10:00:00', 2.0),
(6, 6, 6, '2015-09-21 16:00:00', 3.5),
(7, 7, 7, '2018-03-11 09:00:00', 2.5),
(8, 8, 8, '2018-03-16 10:00:00', 3.0),
(9, 9, 9, '2018-04-21 11:00:00', 2.0),
(10, 10, 10, '2018-06-02 09:00:00', 2.5),
(11, 11, 11, '2018-06-16 10:00:00', 3.0),
(12, 12, 12, '2018-07-02 11:00:00', 1.5),
(13, 13, 13, '2018-08-11 12:00:00', 2.0),
(14, 14, 14, '2018-08-16 15:00:00', 3.5),
(15, 15, 15, '2018-10-26 10:00:00', 2.5),
(16, 16, 16, '2019-01-06 09:00:00', 3.0),
(17, 17, 17, '2019-02-11 11:00:00', 2.0),
(18, 18, 18, '2019-03-16 10:00:00', 2.5),
(19, 19, 19, '2019-04-21 12:00:00', 3.0),
(20, 20, 20, '2019-05-26 11:00:00', 1.5),
(21, 21, 21, '2019-07-01 09:00:00', 2.0),
(22, 22, 22, '2019-07-11 10:00:00', 3.5),
(23, 23, 23, '2019-08-16 11:00:00', 2.5),
(24, 24, 24, '2019-09-21 09:00:00', 3.0),
(25, 25, 25, '2019-10-26 12:00:00', 2.0),
(26, 26, 26, '2019-12-01 11:00:00', 2.5),
(27, 27, 27, '2018-06-10 08:00:00', 3.0),
(28, 28, 28, '2018-07-15 10:00:00', 1.5),
(29, 29, 29, '2015-07-15 15:00:00', 2.5),
(30, 30, 30, '2019-03-20 09:00:00', 2.0);
